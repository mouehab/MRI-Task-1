...
r = RanSeries(3)
xData = r.getSeries2(500, 100, -10, 10)
yData = r.getSeries2(500, 100, -10, 10)
zData = r.getSeries2(500, 100, -10, 10)
...
c.xAxis().setTitle("X-Axis ", "arialbd.ttf", 10)
c.yAxis().setTitle("Y-Axis ", "arialbd.ttf", 10)
c.zAxis().setTitle("Z-Axis ", "arialbd.ttf", 10)

# Output the chart
c.makeChart("NonUniform.png")
